...
# CentOS7 system:
# yum --setopt=ui_repoid_vars=id,releasever,basearch,infra
# repolist
...
# Network information
network --bootproto=static --device=eth0 --gateway=192.168.122.1 --ip=192.168.122.30 --nameserver=8.8.4.4,8.8.8.8 --netmask=255.255.255.0 --ipv6=auto --activate
network --hostname=kcs030.home.org
...
part pv.157 --fstype="lvmpv" --ondisk=vda --size=4607
volgroup os --pesize=4096 pv.157
logvol /  --fstype="xfs" --size=4092 --name=root --vgname=os
